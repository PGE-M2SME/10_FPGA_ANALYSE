...
-- Module  Version: 5.7
--/usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n PLL_IP -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 125 -phase_cntl STATIC -fclkop 148.5 -fclkop_tol 0.1 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -bw 
...
architecture Structure of PLL_IP is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "148.437500";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  4, CLKFB_DIV=>  19, CLKI_DIV=>  16, 
        FIN=> "125.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of PLL_IP is
    for Structure
