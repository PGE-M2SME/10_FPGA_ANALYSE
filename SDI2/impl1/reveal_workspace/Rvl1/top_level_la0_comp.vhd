-- =============================================================================
--  VHDL instance generated by IPExpress    01/26/2021    07:54:49         
--  Filename: top_level_la0_inst.vhd                                          
...
PACKAGE top_level_la0_pkg IS
    COMPONENT top_level_la0
    PORT (
        clk:		IN std_logic;
        ...
        trace_din:	IN std_logic_vector (26 downto 0);
        ip_enable:	IN std_logic
    );

    END COMPONENT;

END PACKAGE top_level_la0_pkg;
