...
/* Module Version: 5.2 */
/* C:\lscc\diamond\1.3\ispfpga\bin\nt\scuba.exe -w -n pll_148 -lang verilog -synth synplify -arch ep5c00 -type pll -fin 27 -phase_cntl STATIC -fclkop 148.5 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -e  */
/* Mon Nov 28 09:38:50 2011 */


`timescale 1 ns / 1 ps
module pll_148 (CLK, CLKOP, LOCK)/* synthesis syn_noprune=1 */;// exemplar attribute pll_148 dont_touch true 
    input wire CLK;
    output wire CLKOP;
    output wire LOCK;
