...
-- Module  Version: 5.7
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n PLL_2 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 180 -phase_cntl STATIC -fclkop 148.5 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -bw 
...
architecture Structure of PLL_2 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "148.500000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "180.000000";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  4, CLKFB_DIV=>  33, CLKI_DIV=>  40, 
        FIN=> "180.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of PLL_2 is
    for Structure
